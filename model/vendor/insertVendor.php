<?php
	...
	if(isset($_POST['vendorDetailsStatus'])){
		...
		$county = htmlentities($_POST['vendorDetailsVendorCity']);
		$constituency = htmlentities($_POST['vendorDetailsVendorDistrict']);
		...
		if(isset($fullName) && isset($mobile) && isset($address)) {
			...
			$sql = 'INSERT INTO vendor(fullName, email, mobile, phone2, address, address2, county, constituency, status) VALUES(:fullName, :email, :mobile, :phone2, :address, :address2, :city, :district, :status)';
