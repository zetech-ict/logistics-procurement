						...
						<div class="card card-outline-secondary my-4">
							...
							<div class="card-body">
								...
								<form>
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="vendorDetailsVendorCity">County</label>
											<input type="text" class="form-control" id="vendorDetailsVendorCity" name="vendorDetailsVendorCity">
										</div>
										<div class="form-group col-md-4">
											<label for="vendorDetailsVendorDistrict">Constituency</label>
						...
						<div class="card card-outline-secondary my-4">
							...
							<div class="card-body">
								...
								<form>
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="customerDetailsCustomerCity">County</label>
											<input type="text" class="form-control" id="customerDetailsCustomerCity" name="customerDetailsCustomerCity">
										</div>
										<div class="form-group col-md-4">
											<label for="customerDetailsCustomerDistrict">Constituency</label>
